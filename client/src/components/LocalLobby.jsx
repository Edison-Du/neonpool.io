...
function LocalLobby({startGame}) {
    ...
    const onPlayerNameSubmit = (e, index) => {
        ...
        if (names[index] === "" || names[index] === defaultName) {
            let newNames = [...names];
            newNames[index] = defaultName;
            setNames(newNames);
        }
        else {
        ...
        <div className="d-flex justify-content-center h-100 w-100">
            <div className="lobby">
                        ...
                        return (
                            <div key={index} className="lobby-player-tag d-flex">
                                ...
                                <input 
                                    ...
                                    ref={ref}
                                />
                                <button onClick={() => editPlayer(index)} title="Edit name">
                                    <svg 
                                        style={{visibility: index === nameBeingEdited ? "hidden" : "visible"}}
                                ...
                                <button onClick={() => deletePlayer(index)} title="Remove player">
                ...
                {names.length < MAX_PLAYERS && 
                    <button onClick={addPlayer} className="add-player" title="Add player">
